            ...
            <div className="flex flex-col items-center justify-start h-screen pt-[5vh] gap-4">
                {!gameStarted && !showInfoPage && (
                    <div className="flex flex-col gap-5 items-center">
                        <h2 className="text-navy text-4xl font-nunito font-bold">Selecteer Niveau</h2>
                        <button
                            onClick={() => fetchHandler('beginner')}
                            className="bg-IceBlue w-full max-w-[300px] text-white text-xl font-nunito font-bold px-6 py-3 rounded-lg shadow-lg outline-black outline-2 hover:bg-[#8FA9D8] transition focus:ring-2 focus:ring-blue-400">
                            Beginner
                        </button>
                        <button
                            onClick={() => fetchHandler('gemiddeld')}
                            className="bg-DuskBlue w-full max-w-[300px] text-white text-xl font-nunito font-bold px-6 py-3 rounded-lg shadow-lg outline-black outline-2 hover:bg-[#4F6490] transition focus:ring-2 focus:ring-blue-400">
                            Gemiddeld
                        </button>
                        <button
                            onClick={() => fetchHandler('gevorderd')}
                            className="bg-SlateBlue w-full max-w-[300px] text-white text-xl font-nunito font-bold px-6 py-3 rounded-lg shadow-lg outline-black outline-2 hover:bg-[#1F355F] transition focus:ring-2 focus:ring-blue-400">
                            Gevorderd
                        </button>
                    </div>
                )}
